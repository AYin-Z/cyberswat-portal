...
const timeline = [
  ...
  },
  {
    year: '2023',
    title: '国赛突破',
    desc: '0psu3 获第十六届全国大学生信息安全竞赛全国二等奖，刷新校史。',
  },
  {
    year: '2024',
    title: '首个国一',
    desc: '第十七届全国大学生信息安全竞赛一等奖，网鼎杯青龙组第4。',
  },
  {
    year: '2025',
    title: '国际舞台',
    desc: 'WMCTF 2025 全球第三；全年国家级奖项 12 项、省部级 20+ 项。',
  },
]
  ...
  <div class="about">
    <section class="page-hero">
      <div class="container">
        ...
        <p class="sub" v-reveal>一支以网络空间安全为使命的预备警官队伍</p>
      </div>
    </section>
    ...
    <section class="intro container">
      <div class="intro-text" v-reveal>
        ...
        <p>
          网特不仅是校园内的技术社团，更是致力于网络安全交流研究的
          <strong>实战化平台</strong>。队伍下设攻防、取证、建模、算法、大数据、开发、
          人工智能、宣传办公室八大部门，紧密围绕「政治建警、科技兴警」理念，
          践行「理论与实战融合、教学与竞赛并重」的培养模式。
        </p>
        <p>
          2025 年，网特队员活跃于全国各类高水平赛事舞台，全年累计斩获
          <strong>国家级奖项 12 项</strong>，省部级及行业重要奖项
          <strong>20 余项</strong>，充分展现了新时代预备警官的科技素养与使命担当。
        </p>
      </div>
    </section>
    ...
    <section class="timeline container">
      <div class="section-head" v-reveal>
        <p class="section-tag">MILESTONES</p>
        <h2 class="section-title">队伍沿革</h2>
      </div>
      <div class="tl">
